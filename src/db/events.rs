        ...
        let rows = stmt
            .query_map(
                ...
                |row| {
                    ...
                    Ok(Event {
                        id: Uuid::parse_str(&id_str).map_err(|_| rusqlite::Error::InvalidColumnType(0, "id".into(), rusqlite::types::Type::Text))?,
                        kind: row.get(1)?,
                        ...
                        timestamp: DateTime::parse_from_rfc3339(&ts_str)
                            .map_err(|_| rusqlite::Error::InvalidColumnType(9, "timestamp".into(), rusqlite::types::Type::Text))?
                            .with_timezone(&Utc),
                    })
                },
            )
